...
def gnn_gat_experiments(root_path, name, DS):
    ...
    for file in sorted(all_files):
        ...
        data = dataset[0]
        test_loss, relative_mse, correlation, p_value, model = train_val_test(data, 64, data.x[1].size()[0])
    ...
    writeToFile(test_loss_dict, root_path+semantics, "gnn_gat")
